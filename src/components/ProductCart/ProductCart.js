...
const ProductCart = ({ product }) => {
  const {_id, name, price, img, description, quantity, SupName } = product;
  ...
  return (
    <div className="bg-gray-100 mb-8  md:mb-0 lg:mb-0 xl:mb-0 shadow-lg  shadow-gray-100 rounded-2xl  bd-white py-4 sm:p-0 p-4">
      <div className=" flex flex-col gap-4 justify-between mx-4">
        ...
        <button onClick={() =>navigateToProductDetail(_id)} className=" py-1 px-6 mx-24 text-white hover:rounded-full rounded-full rounded-tr-none  bg-gradient-to-r from-slate-400 via-blue-400 to-gray-400 hover:bg-gradient-to-r hover:from-slate-500 hover:via-lime-500 hover:to-gray-600 ">
             Update
          </button>
      </div>
    </div>
